...
public class Quiz extends JFrame implements ActionListener {
    ...
    Quiz(String name) {
        ...
        qno = new JLabel();
        qno.setBounds(80, 420, 50, 30);
        qno.setFont(new Font("Tahoma", Font.PLAIN, 20));
        add(qno);

        question = new JLabel();
        question.setBounds(130, 420, 700, 30);
        ...
        next.setBounds(1050, 500, 180, 40);
        ...
        lifeline.setBounds(1050, 570, 180, 40);
        ...
        submit.setBounds(1050, 640, 180, 40);
